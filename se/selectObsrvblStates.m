function  [CmpltObsvrblIdx, ObsvrblIdx] = selectObsrvblStates(casename, Strtgy, MpcInd)
...
%
% References:
% - Davoudi: Davoudi, M. (2012). SENSITIVITY ANALYSIS OF POWER SYSTEM STATE
%   ESTIMATION REGARDING TO NETWORK PARAMETER UNCERTAINTIES
%   [PhD Dissertation]. POLITECNICO DI MILANO.
% - Bo: original contributer to the package.
% - Kerdchuen: Kerdchuen, T. (2009). Measurement Scheme Improving for
%   State Estimation Using Stochastic Tabu Search. International Journal
%   of Electrical and Electronics Engineering, 3(9), 528-531.
